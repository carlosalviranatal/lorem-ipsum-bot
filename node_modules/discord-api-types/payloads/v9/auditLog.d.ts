...
import type { APIAutoModerationAction, APIAutoModerationRule, APIAutoModerationRuleTriggerMetadata, AutoModerationRuleEventType, AutoModerationRuleTriggerType } from 'discord-api-types/payloads/v9/autoModeration';
import type { APIChannel, APIOverwrite } from 'discord-api-types/payloads/v9/channel';
import type { APIGuildIntegration, GuildDefaultMessageNotifications, GuildExplicitContentFilter, GuildMFALevel, GuildVerificationLevel, IntegrationExpireBehavior } from 'discord-api-types/payloads/v9/guild';
import type { APIGuildScheduledEvent, GuildScheduledEventEntityType, GuildScheduledEventStatus } from 'discord-api-types/payloads/v9/guildScheduledEvent';
import type { APIApplicationCommand } from 'discord-api-types/payloads/v9/interactions';
import type { APIRole } from 'discord-api-types/payloads/v9/permissions';
import type { StageInstancePrivacyLevel } from 'discord-api-types/payloads/v9/stageInstance';
import type { StickerFormatType } from 'discord-api-types/payloads/v9/sticker';
import type { APIUser } from 'discord-api-types/payloads/v9/user';
