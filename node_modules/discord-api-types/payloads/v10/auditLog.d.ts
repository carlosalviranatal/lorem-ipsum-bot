...
import type { APIAutoModerationAction, APIAutoModerationRule, APIAutoModerationRuleTriggerMetadata, AutoModerationRuleEventType, AutoModerationRuleTriggerType } from 'discord-api-types/payloads/v10/autoModeration';
import type { APIChannel, APIOverwrite } from 'discord-api-types/payloads/v10/channel';
import type { APIGuildIntegration, GuildDefaultMessageNotifications, GuildExplicitContentFilter, GuildMFALevel, GuildVerificationLevel, IntegrationExpireBehavior } from 'discord-api-types/payloads/v10/guild';
import type { APIGuildScheduledEvent, GuildScheduledEventEntityType, GuildScheduledEventStatus } from 'discord-api-types/payloads/v10/guildScheduledEvent';
import type { APIApplicationCommand } from 'discord-api-types/payloads/v10/interactions';
import type { APIRole } from 'discord-api-types/payloads/v10/permissions';
import type { StageInstancePrivacyLevel } from 'discord-api-types/payloads/v10/stageInstance';
import type { StickerFormatType } from 'discord-api-types/payloads/v10/sticker';
import type { APIUser } from 'discord-api-types/payloads/v10/user';
